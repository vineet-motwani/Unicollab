              ...
              child: Padding(
                ...
                child: FutureBuilder<UsersRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    String? collegeName = otherUserUsersRecord.collegeName;
                    if (collegeName == "Priyadarshini College of Engineering") {
                      collegeName = "PDP";
                    }
                    if (collegeName ==
                        "Karmaveer Dadasaheb Kannamwar (KDK) Engineering") {
                      collegeName = "KDK";
                    }
                    if (collegeName == "Raisoni College of Engineering") {
                      collegeName = "RCE";
                    }
                    if (collegeName == null) {
                      collegeName = "";
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (widget.chatMessagesRef?.pdf != null &&
                                          widget.chatMessagesRef?.pdf != '')
                                        Padding(
                                          padding: const EdgeInsetsDirectional
                                              .fromSTEB(0.0, 12.0, 0.0, 4.0),
                                          child: InkWell(
